...
export default function Footer() {
  ...
  return (
    <footer className="w-full bg-background-secondary/75 py-12 mt-24 border-t border-border-color">
      <div className="max-w-[1200px] mx-auto px-6 lg:px-12 flex flex-col md:flex-row items-center justify-between gap-6 edge-frame">
        ...
        <div className="flex items-center gap-6 text-xs font-semibold uppercase tracking-[0.12em] text-foreground-secondary">
          ...
          <button onClick={scrollToTop} className="flex items-center gap-1 hover:text-accent transition-colors group">
            Back to Top
