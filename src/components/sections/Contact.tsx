...
export default function Contact() {
  return (
    <section id="contact" className="w-full py-28 bg-background border-t border-border-color/40">
            ...
            <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              <div className="flex flex-col gap-2">
                ...
                <input 
                  type="text" 
                  id="name" 
                  className="w-full bg-background-secondary/70 border border-white/14 rounded-xl px-5 py-4 text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 transition-shadow"
              ...
              <div className="flex flex-col gap-2">
                ...
                <textarea 
                  id="message" 
                  rows={5}
                  className="w-full bg-background-secondary/70 border border-white/14 rounded-xl px-5 py-4 text-foreground focus:outline-none focus:ring-2 focus:ring-accent/50 transition-shadow resize-none"
              ...
              <button 
                type="submit" 
                className="w-full md:w-auto mt-2 px-8 py-4 bg-accent text-[#11130f] rounded-full font-semibold uppercase tracking-[0.08em] text-sm hover:scale-[1.02] transition-transform flex items-center justify-center self-start interactive-hover"
              >
                Send Message
              </button>
            </form>
